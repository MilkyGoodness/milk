$(document).ready(function(){
    ...
    $('#twitter-link').click(function() {
        $('.twitter-feed').animate({opacity: 1}, 200);
        return false;
    });
...
// Height of hero image
    ...
    // Anystretch
    $('#bg').anystretch("img/bg.jpg", {speed: 150});

// Switch forms 
    $("#consumer-toggle").click(function(){
        $("#content-container.consumer").fadeOut(200, function() {
            $("#content-container.customer").fadeIn(200);
        });
    });
    $("#customer-toggle").click(function(){
        $("#content-container.customer").fadeOut(200, function() {
            $("#content-container.consumer").fadeIn(200);
        });
    });
